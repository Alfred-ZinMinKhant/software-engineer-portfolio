...
const planned = [
  {
    title: "One login for three products that share no database",
    note: "Identity federation through metadata, and why the gateway stays stateless.",
  },
  {
    title: "JWKS, key rotation, and not locking everyone out",
    note: "Caching public keys with a TTL and a forced-refresh fallback.",
  },
  {
    title: "Evidence a buyer can verify without trusting you",
    note: "Content hashing, hash-chained logs, and on-chain anchoring.",
  },
  {
    title: "Redacting PII before it reaches the model",
